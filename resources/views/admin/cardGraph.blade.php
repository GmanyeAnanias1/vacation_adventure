...
<div class="container mt-4">
    ...
    <div class="row ml-4 mt-20">
        <div class="col-md-12">
            <div class="custom-chart-container ml-5" style="padding-right: 20px;">
            ...
            var registrationChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: {!! json_encode($registrationsByMonth->values()) !!},
                ...
                options: {
                    ...
                    layout: {
                        padding: {
                            right: 20 // Adds padding to the right of the chart
                        }
                    },
                    responsive: true,
